        ...
        <div class="mb-6">
            <form class="flex flex-col space-y-4 " method="POST" action="/">
                ...
                <div >
                    ...
                    <input type="text" name="title" placeholder="Escribe su nombre completo" size="50" class="py-3 px-3 bg-gray-100 rounded-xl ml-10 ">
                ...
                <div >
                    ...
                    <input type="email" name="title" placeholder="Escribe su correo electonico" size="50" class="py-3 px-3 bg-gray-100 rounded-xl ml-10 ">

                </div>

                <div>
                    <input type="password" name="title" placeholder="Escribe su contraseña" size="50" class="py-3 px-3 bg-gray-100 rounded-xl ml-10">
                </div>

                <button class="w-48 ml-4 py-2 shadow-md bg-green-500 hover:bg-green-700 text-white rounded-xl font-bold ml-10 ">Registrar</button>
